...
(function (root, factory) {
  ...
  <div class="sig"><span style="left:${left(0)}">教學組長</span><span style="left:${left(5)}">出納組長</span><span style="left:${left(10)}">會計室</span><span style="left:${left(16)}">校長</span></div>
  <div class="sig sig2"><span style="left:${left(0)}">教務主任</span><span style="left:${left(5)}">總務主任</span></div>
</section>`;
  }
